...
VALUES
    (
        1,
        1,
        'Enjoys web development and cloud computing.',
...
VALUES
    (
        ...
        'Week 1',
        'Overview and Setup',
        'Create the GitHub repositories. Discuss AWS Academy, databases, containers, schemas. Docker Compose Assignment',
    ...
    (
        2,
        'Week 2',
        'Database Container and API',
        'Install PostgreSQL in a container and access the data. Install and setup Django Rest Framework for API - create GET endpoints',
    ...
    (
        ...
        'Discuss documentation and Swagger. Implement filtered GET endpoint as well as POST and PATCH endpoints',
        'https://static1.smartbear.co/swagger/media/assets/images/swagger_logo.svg',
        'Week 3 - API Endpoints and Documentation'
    ),
    (
        4,
        'Week 4',
        'AWS Remote DB, API Container and Mid-Term',
        'Deploy Postgres to an AWS EC2 instance. Connect Django to the remote database and run the API in a local Docker container. Discuss Mid-Term assignment',
        'https://thehawkeye.org/wp-content/uploads/2019/04/Midterm-exams-857x900.png',
        'Week 4 - API Container and Midterm'
    ),
    (
        5,
        'Week 5',
        'AWS Elastic Container Service',
        'Discuss ECR, ECS and Fargate. Deploy the Docker API image to AWS and run it through a Network Load Balancer. Assignment - validate API is running in Faragate',
        'https://miro.medium.com/v2/resize:fit:720/format:webp/1*bEOOOxnCV2nXpGvXkOErRg.png',
        'Week 5 - AWS ECS'
    ),
    (
        6,
        ...
        'Discuss Continuous Integration / Continuous Delivery (CI/CD). Implement GitHub Actions to deploy latest image when code is pushed to repo for API.',
        'https://miro.medium.com/v2/resize:fit:750/format:webp/1*_7mJjD1resPodxT7agk16w.png',
        'Week 6 - CI/CD Pipeline'
    ),
    (
        7,
        'Week 7',
        'Bringing it all Together - Front-end and Final',
        'Attach the front-end (website) to the API and deploy it to AWS S3. Summary of all activities in the class - instructions for Final.',
